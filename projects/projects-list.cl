...
(PROJECT :TITLE "Legends RPG" :DESCRIPTION
	"A software rendered SNES style tactics RPG! This is currently under development, and can be found on github as legends-rpg.")) 
